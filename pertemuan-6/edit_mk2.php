...
<body>
    ...
    if (isset($_POST['kodemk'])) {
        ...
        $jumRowData = mysqli_num_rows($runStrSQL);
        if ($julRowData < 0){
    ...
    <!-- ini end modal -->
        <form method="post" action="registrasi_mk2.php">
            <div class="form-group">
                ...
                <input id="kodemk" class="form-control" type="text" name="kodemk" value="<?php echo $_kodemk ?>" readonly <?php $jngiseng = "disabled";?>>
            </div>
            <div class="form-group">
                <label>Nama Mata Kuliah</label>
                <input id="namamk" class="form-control" type="text" name="namamk" value="<?php echo $_namamk ?>" readonly <?php $jngiseng = "disabled";?>>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>SKS</label>
                <input id="sks" class="form-control" type="text" name="sks" value="<?php echo $_sks ?>" readonly <?php $jngiseng = "disabled";?>>
            </div>           
